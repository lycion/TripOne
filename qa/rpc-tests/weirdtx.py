...
def p2pkh_list(addr):
    return [OP_DUP, OP_HASH160, triponeAddress2bin(addr), OP_EQUALVERIFY, OP_CHECKSIG]
...
class MyTest (TriponeTestFramework):
    ...
    def setup_chain(self, triponeConfDict=None, wallets=None):
        ...
        initialize_chain_clean(self.options.tmpdir, 2, triponeConfDict, wallets)
    ...
    def run_test(self):
        ...
        # triponed is not sophisticated enough to spend this ^
