...
class MyTest (TriponeTestFramework):
    ...
    def run_test(self):
        ...
        try:
            ...
            faulted = True
            pass
        assert faulted, "not signing with tripone cash forkid"
...
def Test():
    ...
    if not os.path.exists(os.path.abspath(here + "/../../src/triponed")):
        dbg = os.path.abspath(here + "/../../debug/src/triponed")
        rel = os.path.abspath(here + "/../../release/src/triponed")
        ...
        cashlib.init(objpath + os.sep + ".libs" + os.sep + "libtriponecash.so")
    else:
        cashlib.init(os.path.abspath(here + "/../../src/.libs/libtriponecash.so"))

    t.main(flags, triponeConf, None)
