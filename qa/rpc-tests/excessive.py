...
class ExcessiveBlockTest (TriponeTestFramework):
    ...
    def run_test(self):
        ...
        TriponeTestFramework.run_test(self)
        self.testCli()
    ...
    def testExcessiveSigops(self):
        ...
        self.nodes[0].generate(100)  # create a lot of TONE for spending
...
def Test():
    ...
    t.main(["--tmpdir=/ramdisk/test", "--nocleanup", "--noshutdown"], triponeConf, None)
