...
class TxnMallTest(TriponeTestFramework):
    ...
    def run_test(self):
        ...
        # First: use raw transaction API to send 1240 TONE to node1_address,
        # but don't broadcast:
        ...
        # Create two spends using 1 50 TONE coin each
        ...
        # Node0's total balance should be starting balance, plus 100TONE for 
