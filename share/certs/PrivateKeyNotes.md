...
unlocked to sign the Tripone-Qt.app bundle.
...
allowing somebody to distribute a Tripone-Qt.app or tripone-qt-setup.exe with a valid
...
that the tripone-qt.exe file inside the installer had not been tampered with.
