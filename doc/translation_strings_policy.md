...
This document provides guidelines for internationalization of the Tripone Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `tripone_en.ts` remains unchanged.
