...
By default, Tripone Unlimited allows up to 125 connections to different peers,
...
Tripone Unlimited adds traffic shaping which is controlled by the following
...
limits are tiny. Keep in mind that tripone's trustless model works best if you are
