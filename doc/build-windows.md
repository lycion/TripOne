...
Below are some notes on how to build Tripone Unlimited for Windows.
...
way. This will install to `c:\workspace\tripone`, for example:

    make install DESTDIR=/mnt/c/workspace/tripone
