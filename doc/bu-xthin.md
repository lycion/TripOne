...
When you run a Tripone Unimited node the XTHIN service is turned on by default.  If you wish to turn it off for some reason
you can use the tripone.conf setting (0 = off, 1 = on) as follows:
