...
if __name__ == "__main__":
    ...
    if len(argv) == 1:
        ...
        print("To run: ./iconmaker.py <input png file 1024px> <output file prefix, eg. tripone>.")
        print("If run with no args, runs: './iconmaker.py icon1024.png tripone'\n")
    else:
        main(argv[1],argv[2])
