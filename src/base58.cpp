...
void CTriponeSecret::SetKey(const CKey &vchSecret)
{
...
bool CTriponeSecret::IsValid() const
{
...
bool CTriponeSecret::SetString(const char *pszSecret) { return CBase58Data::SetString(pszSecret) && IsValid(); }
bool CTriponeSecret::SetString(const std::string &strSecret) { return SetString(strSecret.c_str()); }
