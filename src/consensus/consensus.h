...
#ifndef TRIPONE_CONSENSUS_CONSENSUS_H
#define TRIPONE_CONSENSUS_CONSENSUS_H
...
/** This is the default max bloom filter size allowed on the tripone network.  In Tripone Unlimited we have the ability
...
#endif // TRIPONE_CONSENSUS_CONSENSUS_H
