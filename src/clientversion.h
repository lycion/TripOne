...
#ifndef TRIPONE_CLIENTVERSION_H
#define TRIPONE_CLIENTVERSION_H
...
//! These need to be macros, as clientversion.cpp's and tripone*-res.rc's voodoo requires it
...
/**
 * triponed-res.rc includes this file, but it cannot cope with real c++ code.
