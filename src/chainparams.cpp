...
public:
    CMainParams()
    {
        ...
        // List of Tripone Cash compatible seeders
        vSeeds.push_back(CDNSSeedData("tripone.info", "tonecash-seeder.tripone.info", true));
        vSeeds.push_back(CDNSSeedData("triponeabc.org", "seed.triponeabc.org", true));
        vSeeds.push_back(CDNSSeedData("triponeforks.org", "seed-abc.triponeforks.org", true));
...
public:
    CUnlParams()
    {
        ...
        vFixedSeeds.clear();
        vSeeds.clear();
        vSeeds.push_back(CDNSSeedData("tripone.info", "nolnet-seed.tripone.info", true));
...
public:
    CTestNetParams()
    {
        ...
        // Tripone ABC seeder
        vSeeds.push_back(CDNSSeedData("triponeabc.org", "testnet-seed.triponeabc.org", true));
        // triponeforks seeders
        vSeeds.push_back(CDNSSeedData("triponeforks.org", "testnet-seed-abc.triponeforks.org", true));
        // BU seeder
        vSeeds.push_back(CDNSSeedData("tripone.info", "testnet-seed.tripone.info", true));
        // Bitprim
