...
static int AppInitRawTx(int argc, char *argv[])
{
    ...
    // Parameters
    //
    AllowedArgs::TriponeTx allowedArgs;
    try
    {
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help") || mapArgs.count("-version"))
    {
        ...
        std::string strUsage =
            strprintf(_("%s tripone-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n";
        ...
        strUsage = "\n" + _("Usage:") + "\n" + "  tripone-tx [options] <hex-tx> [commands]  " +
                   _("Update hex-encoded tripone transaction") + "\n" + "  tripone-tx [options] -create [commands]   " +
                   _("Create hex-encoded tripone transaction") + "\n" + "\n";
...
static int CommandLineRawTx(int argc, char *argv[])
{
    ...
    try
    {
        ...
        if (!fCreateBlank)
        {
            ...
            // param: hex-encoded tripone transaction
