...
#ifndef TRIPONE_UNLIMITED_H
#define TRIPONE_UNLIMITED_H
...
extern uint256 triponeCashForkBlockHash;
...
extern void GenerateTripones(bool fGenerate, int nThreads, const CChainParams &chainparams);
