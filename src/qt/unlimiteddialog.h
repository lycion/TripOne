...
#ifndef TRIPONE_QT_UNLIMITEDDIALOG_H
#define TRIPONE_QT_UNLIMITEDDIALOG_H
...
// Minimum time in ms to show notifications (used in TriponeGUI not the Unlimited dialog)
