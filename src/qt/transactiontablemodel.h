...
#ifndef TRIPONE_QT_TRANSACTIONTABLEMODEL_H
#define TRIPONE_QT_TRANSACTIONTABLEMODEL_H
...
private:
    ...
    QString formatTxAmount(const TransactionRecord *wtx,
        ...
        TriponeUnits::SeparatorStyle separators = TriponeUnits::separatorStandard) const;
...
#endif // TRIPONE_QT_TRANSACTIONTABLEMODEL_H
