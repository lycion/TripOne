...
#ifndef TRIPONE_QT_RECEIVECOINSDIALOG_H
#define TRIPONE_QT_RECEIVECOINSDIALOG_H
...
/** Dialog for requesting payment of tripones */
...
#endif // TRIPONE_QT_RECEIVECOINSDIALOG_H
