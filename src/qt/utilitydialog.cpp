 ...
 */
    ...
    else
    {
        ...
        QString header =
            tr("Usage:") + "\n" + "  tripone-qt [" + tr("command-line options") + "]                     " + "\n";
        ...
        std::string strUsage = AllowedArgs::TriponeQt(&tweaks).helpMessage();
...
void ShutdownWindow::showShutdownWindow(TriponeGUI *window)
{
    if (!window)
        return;
