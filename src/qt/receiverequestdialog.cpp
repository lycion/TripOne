...
#include "config/tripone-config.h" /* for USE_QRCODE */
#endif
...
void ReceiveRequestDialog::update()
{
    ...
    QString uri = GUIUtil::formatTriponeURI(*cfg, info);
    ...
    if (info.amount)
        html += "<b>" + tr("Amount") + "</b>: " +
                TriponeUnits::formatHtmlWithUnit(model->getDisplayUnit(), info.amount) + "<br>";
...
void ReceiveRequestDialog::on_btnCopyURI_clicked() { GUIUtil::setClipboard(GUIUtil::formatTriponeURI(*cfg, info)); }
