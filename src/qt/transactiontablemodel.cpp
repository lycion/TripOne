      ...
      fProcessingQueuedTransactions(false), platformStyle(_platformStyle)
{
    columns << QString() << QString() << tr("Date") << tr("Type") << tr("Address or Label")
            << TriponeUnits::getAmountColumnTitle(walletModel->getOptionsModel()->getDisplayUnit());
    priv->refreshWallet();
...
{
    columns[Amount] = TriponeUnits::getAmountColumnTitle(walletModel->getOptionsModel()->getDisplayUnit());
...
QString TransactionTableModel::formatTxAmount(const TransactionRecord *wtx,
    ...
    TriponeUnits::SeparatorStyle separators) const
{
    QString str = TriponeUnits::format(
...
QVariant TransactionTableModel::data(const QModelIndex &index, int role) const
{
    ...
    case Qt::DisplayRole:
        ...
        case Amount:
            return formatTxAmount(rec, true, TriponeUnits::separatorAlways);
        }
        break;
    case Qt::EditRole:
    ...
    case FormattedAmountRole:
        ...
        return formatTxAmount(rec, false, TriponeUnits::separatorNever);
    case StatusRole:
