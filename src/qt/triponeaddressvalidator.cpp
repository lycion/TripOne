...
TriponeAddressEntryValidator::TriponeAddressEntryValidator(const std::string &_cashaddrprefix, QObject *parent)
    : QValidator(parent), cashaddrprefix(_cashaddrprefix)
{
}

QValidator::State TriponeAddressEntryValidator::validate(QString &input, int &pos) const
{
    Q_UNUSED(pos);
...
TriponeAddressCheckValidator::TriponeAddressCheckValidator(QObject *parent) : QValidator(parent) {}
QValidator::State TriponeAddressCheckValidator::validate(QString &input, int &pos) const
{
    Q_UNUSED(pos);
    // Validate the passed Tripone address
