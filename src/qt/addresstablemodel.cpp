...
public:
    ...
    void updateEntry(const QString &address, const QString &label, bool isMine, const QString &purpose, int status)
    {
        ...
        QList<AddressTableEntry>::iterator lower =
            qLowerBound(cachedAddressTable.begin(), cachedAddressTable.end(), address, AddressTableEntryLessThan());
        QList<AddressTableEntry>::iterator upper =
            qUpperBound(cachedAddressTable.begin(), cachedAddressTable.end(), address, AddressTableEntryLessThan());
...
void AddressTableModel::updateEntry(const QString &address,
    ...
    int status)
{
    // Update address book model from Tripone core
    ...
    const CScriptNum nFreezeLockTime)
{
    ...
    {
        LOCK(wallet->cs_wallet);
        wallet->SetAddressBook(DecodeDestination(strAddress), strLabel, (type == Send ? "send" : "receive"));
    }
