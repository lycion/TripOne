...
#ifndef TRIPONE_ALLOWED_ARGS_H
#define TRIPONE_ALLOWED_ARGS_H
...
class TriponeCli : public AllowedArgs
{
public:
    TriponeCli();
};

class Triponed : public AllowedArgs
{
public:
    Triponed(CTweakMap *pTweaks = nullptr);
};

class TriponeQt : public AllowedArgs
{
public:
    TriponeQt(CTweakMap *pTweaks = nullptr);
};

class TriponeTx : public AllowedArgs
{
public:
    TriponeTx();
};
