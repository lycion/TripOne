...
#ifndef TRIPONE_PROTOCOL_H
#define TRIPONE_PROTOCOL_H
...
/**
 * Tripone protocol message types. When adding new message types, don't forget
 ...
 * @see https://tripone.org/en/developer-reference#version
 */
extern const char *VERSION;
/**
 * The verack message acknowledges a previously-received version message,
 * informing the connecting node that it can begin to send other messages.
 * @see https://tripone.org/en/developer-reference#verack
 */
extern const char *VERACK;
/**
 * The addr (IP address) message relays connection information for peers on the
 * network.
 * @see https://tripone.org/en/developer-reference#addr
 */
extern const char *ADDR;
/**
 * The inv message (inventory message) transmits one or more inventories of
 * objects known to the transmitting peer.
 * @see https://tripone.org/en/developer-reference#inv
 */
extern const char *INV;
/**
 * The getdata message requests one or more data objects from another node.
 * @see https://tripone.org/en/developer-reference#getdata
 */
 ...
 * @see https://tripone.org/en/developer-reference#merkleblock
 */
extern const char *MERKLEBLOCK;
/**
 * The getblocks message requests an inv message that provides block header
 * hashes starting from a particular point in the block chain.
 * @see https://tripone.org/en/developer-reference#getblocks
 */
 ...
 * @see https://tripone.org/en/developer-reference#getheaders
 */
extern const char *GETHEADERS;
/**
 * The tx message transmits a single transaction.
 * @see https://tripone.org/en/developer-reference#tx
 */
 ...
 * @since protocol version 31800.
 * @see https://tripone.org/en/developer-reference#headers
 */
extern const char *HEADERS;
/**
 * The block message transmits a single serialized block.
 * @see https://tripone.org/en/developer-reference#block
 */
 ...
 * @see https://tripone.org/en/developer-reference#getaddr
 */
 ...
 * @see https://tripone.org/en/developer-reference#mempool
 */
extern const char *MEMPOOL;
/**
 * The ping message is sent periodically to help confirm that the receiving
 * peer is still connected.
 * @see https://tripone.org/en/developer-reference#ping
 */
 ...
 * @see https://tripone.org/en/developer-reference#pong
 */
 ...
 * @see https://tripone.org/en/developer-reference#notfound
 */
 ...
 * @see https://tripone.org/en/developer-reference#filterload
 */
 ...
 *   Only available with service bit NODE_BLOOM since protocol version
 *   70011 as described by BIP111.
 * @see https://tripone.org/en/developer-reference#filteradd
 */
 ...
 *   Only available with service bit NODE_BLOOM since protocol version
 *   70011 as described by BIP111.
 * @see https://tripone.org/en/developer-reference#filterclear
 */
 ...
 * @see https://tripone.org/en/developer-reference#reject
 */
 ...
 * @see https://tripone.org/en/developer-reference#sendheaders
 */
...
enum
{
    ...
    // set by all Tripone Unlimited nodes, and is unset by SPV clients or other peers that just want
    // network services but don't provide them.
    NODE_NETWORK = (1 << 0),
    // NODE_GETUTXO means the node is capable of responding to the getutxo protocol request.
    // Tripone Unlimited does not support this but a patch set called Tripone XT does.
    // See BIP 64 for details on how this is implemented.
    NODE_GETUTXO = (1 << 1),
    // NODE_BLOOM means the node is capable and willing to handle bloom-filtered connections.
    // Tripone Unlimited nodes used to support this by default, without advertising this bit,
    // but no longer do as of protocol version 70011 (= NO_BLOOM_VERSION)
    NODE_BLOOM = (1 << 2),

    // Indicates that a node can be asked for blocks and transactions including
    // witness data.
    // BU: Tripone Unlimitd does not support this (added to display connected node services correctly)
    NODE_WITNESS = (1 << 3),
    ...
    // UAHF
    // NODE_TRIPONE_CASH means the node supports the UAHF hard fork.  This is intended to be just
    ...
    // Tripone Unlimited devevelopement team. Remember that service bits are just
