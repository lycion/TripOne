 ...
 */
#ifndef TRIPONE_UTIL_H
#define TRIPONE_UTIL_H
...
extern const char *const TRIPONE_CONF_FILENAME;
extern const char *const TRIPONE_PID_FILENAME;
...
{
    std::string s = strprintf("tripone-%s", name);
