...
{
    BOOST_CHECK(TestSplitHost("www.tripone.org", "www.tripone.org", -1));
    BOOST_CHECK(TestSplitHost("[www.tripone.org]", "www.tripone.org", -1));
    BOOST_CHECK(TestSplitHost("www.tripone.org:80", "www.tripone.org", 80));
    BOOST_CHECK(TestSplitHost("[www.tripone.org]:80", "www.tripone.org", 80));
    BOOST_CHECK(TestSplitHost("127.0.0.1", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("127.0.0.1:9773", "127.0.0.1", 9773));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]:9773", "127.0.0.1", 9773));
    BOOST_CHECK(TestSplitHost("::ffff:127.0.0.1", "::ffff:127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[::ffff:127.0.0.1]:9773", "::ffff:127.0.0.1", 9773));
    BOOST_CHECK(TestSplitHost("[::]:9773", "::", 9773));
    BOOST_CHECK(TestSplitHost("::9773", "::9773", -1));
    BOOST_CHECK(TestSplitHost(":9773", "", 9773));
    BOOST_CHECK(TestSplitHost("[]:9773", "", 9773));
...
BOOST_AUTO_TEST_CASE(netbase_lookupnumeric)
{
    ...
    BOOST_CHECK(TestParse("127.0.0.1:9773", "127.0.0.1:9773"));
    BOOST_CHECK(TestParse("::ffff:127.0.0.1", "127.0.0.1:65535"));
    BOOST_CHECK(TestParse("::", "[::]:65535"));
    BOOST_CHECK(TestParse("[::]:9773", "[::]:9773"));
    BOOST_CHECK(TestParse("[127.0.0.1]", "127.0.0.1:65535"));
