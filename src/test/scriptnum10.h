...
#ifndef TRIPONE_TEST_SCRIPTNUM10_H
#define TRIPONE_TEST_SCRIPTNUM10_H
...
{
    /**
     * The ScriptNum implementation from Tripone Unlimited 0.10.0, for cross-comparison.
     */
public:
