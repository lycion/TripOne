...
BOOST_AUTO_TEST_CASE(util_ParseParameters)
{
    ...
    ParseParameters(0, (char **)argv_test, AllowedArgs::Triponed());
    BOOST_CHECK(mapArgs.empty() && mapMultiArgs.empty());

    ParseParameters(1, (char **)argv_test, AllowedArgs::Triponed());
    BOOST_CHECK(mapArgs.empty() && mapMultiArgs.empty());

    ParseParameters(5, (char **)argv_test, AllowedArgs::Triponed());
