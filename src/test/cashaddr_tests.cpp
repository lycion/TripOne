...
BOOST_AUTO_TEST_CASE(cashaddr_testvectors_valid)
{
    static const std::string CASES[] = {
        "prefix:x64nx6hz", "PREFIX:X64NX6HZ", "p:gpf8m4h7", "triponecash:qpzry9x8gf2tvdw0s3jn54khce6mua7lcw20ayyn",
...
BOOST_AUTO_TEST_CASE(cashaddr_testvectors_noprefix)
{
    static const std::pair<std::string, std::string> CASES[] = {
        {"triponecash", "qpzry9x8gf2tvdw0s3jn54khce6mua7lcw20ayyn"}, {"prefix", "x64nx6hz"}, {"PREFIX", "X64NX6HZ"},
        {"p", "gpf8m4h7"}, {"triponecash", "qpzry9x8gf2tvdw0s3jn54khce6mua7lcw20ayyn"},
        {"bchtest", "testnetaddress4d6njnut"}, {"bchreg", "555555555555555555555555555555555555555555555udxmlmrz"},
    };
