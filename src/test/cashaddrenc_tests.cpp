...
BOOST_AUTO_TEST_CASE(test_addresses)
{
    ...
    std::vector<std::string> pubkey = {"triponecash:qpm2qsznhks23z7629mms6s4cwef74vcwvy22gdx6a",
        "triponecash:qr95sy3j9xwd2ap32xkykttr4cvcu7as4y0qverfuy",
        "triponecash:qqq3728yw0y47sqn6l2na30mcw6zm78dzqre909m2r"};
    std::vector<std::string> script = {"triponecash:ppm2qsznhks23z7629mms6s4cwef74vcwvn0h829pq",
        "triponecash:pr95sy3j9xwd2ap32xkykttr4cvcu7as4yc93ky28e",
        "triponecash:pqq3728yw0y47sqn6l2na30mcw6zm78dzq5ucqzc37"};
