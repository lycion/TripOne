...
CTweakRef<int> minXthinNodesTweak("net.minXthinNodes",
    ...
    &nMinXthinNodes);
// When should I request a tx from someone else (in microseconds). cmdline/tripone.conf: -txretryinterval
...
// When should I request a block from someone else (in microseconds). cmdline/tripone.conf: -blkretryinterval
...
uint256 triponeCashForkBlockHash = uint256S("000000000000000000651ef99cb9fcbe0dadde1d424bd9f15ff20136191a5eec");
